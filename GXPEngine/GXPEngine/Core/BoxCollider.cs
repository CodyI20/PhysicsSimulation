	...
	public class BoxCollider : Collider
	{
		...
		public override bool HitTest (Collider other) {
			if (other is BoxCollider) {
				global::Vec2[] c = _owner.GetExtents();
				if (c == null) return false;
				global::Vec2[] d = ((BoxCollider)other)._owner.GetExtents();
		...
		public override bool HitTestPoint (float x, float y) {
			global::Vec2[] c = _owner.GetExtents();
			if (c == null) return false;
			global::Vec2 p = new global::Vec2(x, y);
		...
		//														areaOverlap()
		//------------------------------------------------------------------------------------------------------------------------
		private bool areaOverlap(global::Vec2[] c, global::Vec2[] d) {
			// normal 1:
		...
		private bool pointOverlapsArea(global::Vec2 p, global::Vec2[] c) {
		...
		public override float TimeOfImpact (Collider other, float vx, float vy, out global::Vec2 normal) {
			normal = new global::Vec2 ();
			if (other is BoxCollider) {
				global::Vec2[] c = _owner.GetExtents();
		...
		private bool updateImpactExitTime(float cx, float cy, float nx, float ny, float dx, float dy, global::Vec2[] d, float vx, float vy, ref float maxTOI, ref float minTOE) {
			float dot = (dy * ny + dx * nx);
		...
		public override Collision GetCollisionInfo (Collider other) 
		{
			...
			global::Vec2 normal=new global::Vec2();
			global::Vec2 point=new global::Vec2();
			if (other is BoxCollider) {
		...
		private bool updateCollisionPoint(
			float cx, float cy, float nx, float ny, float dx, float dy, global::Vec2[] d, bool invertNormal,
			ref float minPenetrationDepth, ref global::Vec2 normal, ref global::Vec2 point
		) {
			float dot = (dy * ny + dx * nx);

			if (dot == 0.0f) dot = 1.0f; // hm

			global::Vec2 argMin=new global::Vec2();
			global::Vec2 argMax=new global::Vec2();
